...
export type GetLessonQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, lessonType: LessonType, title: string, slug: string, availableAt?: any | null }> };
